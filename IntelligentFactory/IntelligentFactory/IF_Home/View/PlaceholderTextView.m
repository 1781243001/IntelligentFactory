...
-(void)layoutSubviews{
    self.placeholderLabel.frame = CGRectMake(8, 8, self.frame.size.width-8, self.frame.size.height);
...
//        self.contentInset = UIEdgeInsetsMake(0, 0, self.wordNumLabel.frame.size.height-5, 0);
