...
- (void)dismiss:(BOOL)isAnimated{
    if (isAnimated) {
        ...
        if (object && [object isKindOfClass:[NSDictionary class]]) {
            ...
            [self dismissWithDuration:duration elasticAnimated:NO];
        }
    ...
    switch (_layoutType) {
        case PopupLayoutTypeCenter: {
            ...
            switch (_transitStyle) {
                ...
                case PopupTransitStyleShrinkInOut:
                    _popupView.transform = _dismissOppositeDirection ? CGAffineTransformMakeScale(1.95, 1.95) : CGAffineTransformMakeScale(0.00, 0.0);
                    return _maskView.center;
