$(function(){
	...
	var jlWorkshopAll = baseObj.getQuery(window.location.search, 'sjson');
	//var DepartmentAll = '[{"id":"5466","text":"化工部东区","orderId":0,"selected":1},{"id":"5461","text":"化工部西区","orderId":0,"selected":1}]'
	/*var P = '<p>'+jlWorkshopAll+'</p><p>第三方斯蒂芬</p>';
	$("body").append(P)*/
	
	if(jlWorkshopAll == ""){
		//bm_mrAreaListData()
	} else {
		localStorage.setItem("jlWorkshop",jlWorkshopAll);
		var jlWorkshop = JSON.parse(localStorage.getItem("jlWorkshop"));
		console.log(jlWorkshop)
		//bm_dzAreaListData(workshop)
	}
    ...
    $(".right_c ").on("click",function(){
    	//console.log(1111111)
    	var areaId = "";
    	window.location.href = "jiLiangFXzhz.html?areaId="+areaId+"&FactoryData=";
    	//window.location.href = "jiLiangFXzhz.html?FactoryData=";
    })
